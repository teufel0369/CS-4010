...
public class VolunteerDB {
    ...
    public static synchronized void insertUser(Volunteer user) throws IOException, ParseException {
        ...
        Object obj = parser.parse(new FileReader("/classes/Java/j-thompson/tomcat/VolunteerDB.json"));
        ...
        try(FileWriter file = new FileWriter("../classes/Java/j-thompson/tomcat/VolunteerDB.json")){
    ...
    public static synchronized boolean verifyUser(Volunteer volunteer){
        ...
        try{
            Object obj = parser.parse(new FileReader("/usr/share/tomcat/webapps/j-thompson/VolunteerDB.json")); //parse the file
